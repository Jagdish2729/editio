...
export default function CreatorEdit() {
  ...
  async function submitOrder(){
    ...
    try{
      ...
      const order=createOrder({mode,modeLabel:selectedMode.title,format,vibe,brief:brief.trim(),reference:reference.trim(),clipNames,clipUrls,clipCount:clipUrls.length,aiStatus:mode==="human"?"not_started":"queued",renderStatus:mode==="human"?"not_started":"rendering"});
